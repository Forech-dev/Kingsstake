...
#if defined(NDEBUG)
# error "King cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "King Signed Message:\n";
    ...
    int64_t nSubsidy = nCoinAge * COIN_YEAR_REWARD * 33 / (365 * 33 + 8);
			...
			
			{
				nSubsidy = nSubsidy * 5; // 500%
                         ...
                         {
                                 nSubsidy = nSubsidy * 60 ;  //6000% Superblocks
                         }
                         ...
                         {
                                 nSubsidy = nSubsidy * 6 ;  //6000% Superblocks
                         }
                         ...
                         {
                                 nSubsidy = nSubsidy * 60 ;  //6000% Superbloks
						 }
                         ...
                         {
                                 nSubsidy = nSubsidy * 60 ;  //6000 last Superblocks
