...
namespace json_spirit
{
    ...
    class Generator
    {
        ...
        typedef typename String_type::value_type Char_type;
        typedef typename Object_type::value_type Obj_mking_type;
    ...
    private:
        ...
        void output( const Obj_mking_type& mking )
        {
            output( Config_type::get_name( mking ) ); space(); 
            os_ << ':'; space(); 
            output( Config_type::get_value( mking ) );
        }
